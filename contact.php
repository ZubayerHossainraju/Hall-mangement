...
<div id="header">
 ...
 <h2> Hall Management</h2>
  ...
  <div id="menu">
              <ul>
			        <li> <a href="student.php"><b>Main page</b></a></li>
...
if(isset($_REQUEST['submit'])){
	...
	$insert="insert into message(name,email,position,message)
	values('$name','$email','$position','$message');";
	
	if(mysqli_query($conn,$insert)){
		echo "<script>window.open('contact.php?inserted=RECORD HAS BEEN INSERTED SUCCESSFULLY','_self')</script>";
